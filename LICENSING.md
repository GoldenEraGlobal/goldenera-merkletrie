# Licensing Guide for goldenera-merkletrie
...
- `src/main/java/global/goldenera/merkletrie/MerkleTrie.java`
- `src/main/java/global/goldenera/merkletrie/RangeManager.java`
- `src/main/java/global/goldenera/merkletrie/patricia/BranchNode.java`
- `src/main/java/global/goldenera/merkletrie/patricia/ExtensionNode.java`
- `src/main/java/global/goldenera/merkletrie/patricia/LeafNode.java`
...
All files in `global.goldenera.merkletrie` package except those listed below as dual-licensed (unmodified from Hyperledger Besu)

### Dual-Licensed (Apache 2.0 OR MIT)
```
src/main/java/global/goldenera/merkletrie/MerkleTrie.java       (modified)
src/main/java/global/goldenera/merkletrie/RangeManager.java      (modified)
src/main/java/global/goldenera/merkletrie/patricia/BranchNode.java      (modified)
src/main/java/global/goldenera/merkletrie/patricia/ExtensionNode.java      (modified)
src/main/java/global/goldenera/merkletrie/patricia/LeafNode.java      (modified)
```
...
3. Use dual-license header (see MerkleTrie.java as template)
