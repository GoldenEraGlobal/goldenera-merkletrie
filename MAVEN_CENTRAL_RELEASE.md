# Maven Central release: goldenera-merkletrie 0.0.1

Coordinates:

```xml
<dependency>
    <groupId>global.goldenera.merkletrie</groupId>
    <artifactId>goldenera-merkletrie</artifactId>
...
https://repo1.maven.org/maven2/global/goldenera/merkletrie/goldenera-merkletrie/0.0.1/
...
This repository keeps the approved coordinates unchanged: `global.goldenera.merkletrie:goldenera-merkletrie:0.0.1`.
