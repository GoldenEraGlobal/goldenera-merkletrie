...
public class TrieNodeDecoder {
  private static final StoredNodeFactory<Bytes> emptyNodeFactory = new StoredNodeFactory<>((l, h) -> Optional.empty(),
  ...
  /**
   * Flattens this node and all of its inlined nodes and node references into a
   * list.
   *
   * @param location The location in the trie.
  ...
  /**
   * Walks the trie in a bread-first manner, returning the list of nodes
   * encountered in order. If
   ...
   * @param maxDepth   The maximum depth to traverse to. A value of zero will
