...
import global.goldenera.rlp.BytesValueRLPOutput;
import global.goldenera.rlp.RLP;
import global.goldenera.cryptoj.datatypes.Hash;
import global.goldenera.merkletrie.CompactEncoding;
import global.goldenera.merkletrie.LocationNodeVisitor;
import global.goldenera.merkletrie.Node;
import global.goldenera.merkletrie.NodeFactory;
import global.goldenera.merkletrie.NodeVisitor;
import global.goldenera.merkletrie.PathNodeVisitor;
...
public class ExtensionNode<V> implements Node<V> {
  ...
  public Bytes32 getHash() {
    ...
    final Bytes32 hashed = Hash.hash(rlp);
    hash = new SoftReference<>(hashed);
    return hashed;
  }

  public Node<V> replaceChild(final Node<V> updatedChild) {
    // collapse this extension - if the child is a branch, it will create a new
    // extension
